...
Config.Visualization.figureSettingsList{nFigures}.numOfFigures = 5;
Config.Visualization.figureSettingsList{nFigures}.numOfSubFigures = 5;
Config.Visualization.figureSettingsList{nFigures}.totalSubFiguresSinglePlot = [3,2];
Config.Visualization.figureSettingsList{nFigures}.Settings = Settings;
Config.Visualization.figureSettingsList{nFigures}.Settings.yLabel = {'Torques [Nm]'};
Config.Visualization.figureSettingsList{nFigures}.modeMultiplePlot = 'newplot';  
Config.Visualization.figureSettingsList{nFigures}.legendList = {'torsoPitch','torsoRoll','torsoYaw', ...
